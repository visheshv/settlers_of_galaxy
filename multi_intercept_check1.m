function [store_close_stars]=multi_intercept_check1(t_hist,r_hist,v_hist,R_vec,phi_vec,omega_vec,i_vec,v_vec,n_vec)
...
store_crossing_stars=zeros(length(R_vec),2);
...
for i=1:length(R_vec)
        ...
        if norm(r0)>norm(r0_ms)*0.98 && norm(r0)<norm(rf_ms)*1.02 && ang1 <90 && ang2 >90
