function idx_selection = find_closest_momentum_star_mothership_strategy7(x0,n,star_ID,x,y,z, mothership_id, mothership_controls, num_impulses,kms2kpcpmyr,R_vec,phi_vec,omega_vec,i_vec,n_vec,v_vec,t_departure,star_databse)
...
% star_database: contains stars near grid centers
